...
export const PATH_FEATURE_MAP: Record<string, Feature> = {
  ...
  "/admin/pricing/compare": "pricing",
  "/admin/pricing/classification": "pricing",
  ...
  "/admin/crm/outbox": "crm",
  "/admin/crm/activities": "crm",
  // Helpdesk
  "/admin/helpdesk": "helpdesk",
  "/admin/helpdesk/overview": "helpdesk",
  ...
  "/admin/orders/quotations": "quotations",
  "/admin/orders/stock-orders": "orders",
  "/admin/orders": "orders",
  ...
  "/admin/finance/bank-payment-portals": "integrations",
  "/admin/finance/walk-in-payments": "integrations",
  ...
  "/admin/settings/edge-functions": "runtime-errors",
  // Legacy paths
