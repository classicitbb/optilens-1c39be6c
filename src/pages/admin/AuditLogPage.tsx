...
const AuditLogPage = () => {
  ...
  return (
    <div className="p-4 space-y-4 border py-[10px] px-[10px]">
      ...
      {/* Search */}
      <div className="relative max-w-xs py-[13px] border">
        <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 px-px py-px" style={{ color: "hsl(215 15% 50%)" }} />
