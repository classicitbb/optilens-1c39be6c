...
const EMAIL_TEMPLATES: EmailTemplate[] = [
  ...
  { id: "recovery", group: "Authentication", title: "Password reset", trigger: "Password reset requested", recipient: "Account holder", subject: "Reset your password", preheader: "Reset your password for Classic Visions", heading: "Reset your password", paragraphs: ["We received a request to reset your password for Classic Visions.", "Select Reset Password to return to the secure Classic Visions page and choose a new password.", "If you didn't request a password reset, you can safely ignore this email. Your password will not be changed."], cta: "Reset Password", source: "_shared/email-templates/recovery.tsx" },
