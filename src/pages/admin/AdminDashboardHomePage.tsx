...
const appTiles = [
  ...
  {
    title: "CRM",
    description: "Contacts, leads, pipeline, proposals, and sales activities.",
  ...
  {
    title: "Orders",
    description: "Orders, quotations, Rx and stock order entry, lab submissions.",
    route: "/admin/orders",
    icon: ShoppingCart,
  ...
  {
    title: "Website",
    description: "Portals, storefront products, and site content.",
...
const QUICK_ACTIONS = [
  ...
  },
  {
    ...
    icon: Package,
    href: "/admin/orders/stock-orders",
    featurePrefix: "orders" as const,
  },
  {
    key: "log-activity",
