    ...
    <div className="flex flex-col h-full p-4 gap-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" className="h-8 text-xs gap-1.5" onClick={() => navigate(`/admin/orders/quotations/${quote.id}`)}>
          ...
          <Button variant="secondary" size="sm" className="h-8 text-xs gap-1.5" onClick={() => navigate("/admin/orders/quotations")}>
