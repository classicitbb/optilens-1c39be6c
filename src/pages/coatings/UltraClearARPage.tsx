...
const UltraClearARPage = () => {
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="Super AR Coating — Premium Anti-Reflective | Classic Visions"
        description="Learn how Super AR improves lens transparency, night-driving comfort, cosmetic appearance, and cleaning performance with a premium multi-layer anti-reflective stack."
      ...
      <main className="pb-20 pt-24">
        ...
        <section className="container mx-auto max-w-6xl px-4 lg:px-8">
          ...
          <h1 className="mt-3 text-4xl font-bold text-foreground sm:text-5xl">Super&nbsp;AR</h1>
        ...
        <section className="mt-20 bg-muted/40 py-16">
          <div className="container mx-auto max-w-6xl px-4 lg:px-8">
            <h2 className="text-2xl font-bold text-foreground">How Super AR Works</h2>
            <p className="mt-1 max-w-2xl text-muted-foreground">
              Each layer in the Super AR system serves a specific purpose — from scratch protection at the base to oil repellency at the top.
            </p>
        ...
        <section className="container mx-auto mt-20 max-w-6xl px-4 lg:px-8">
          ...
          <p className="mt-1 text-muted-foreground">Position Super AR as best-in-class for these patient profiles.</p>
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {IDEAL_WEARERS.map((w) => (
        ...
        <section className="container mx-auto mt-20 max-w-6xl px-4 lg:px-8">
          <Card className="border-none bg-primary text-primary-foreground">
            <CardContent className="flex flex-col items-center gap-4 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h2 className="text-xl font-bold">Upgrade to Super AR</h2>
