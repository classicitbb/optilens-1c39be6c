                ...
                <div className="mt-8 max-w-3xl rounded-2xl border border-border/60 bg-background/90 p-3 shadow-sm backdrop-blur">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-11 rounded-xl border-0 bg-transparent pl-12 pr-12 text-sm shadow-none focus-visible:ring-0"
                    />
                ...
                <CardContent className="p-4">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-3">
                    <div className="rounded-xl bg-muted/50 p-3">
                      <p className="text-2xl font-semibold text-foreground">{totalArticles}</p>
                      <p className="mt-0.5 text-xs text-muted-foreground">articles and linked guides</p>
                    </div>
                    <div className="rounded-xl bg-muted/50 p-3">
                      <p className="text-2xl font-semibold text-foreground">{categories.length}</p>
                      <p className="mt-0.5 text-xs text-muted-foreground">organized categories</p>
                    </div>
                  </div>

                  <div className="mt-3 rounded-xl border border-border/60 bg-card p-3">
                    <p className="text-xs font-semibold text-foreground">Popular starting points</p>
                    <div className="mt-2 space-y-1.5">
                      {featuredEntries.slice(0, 3).map((entry) => (
                        <button
                          ...
                          className="flex w-full items-start justify-between gap-2 rounded-lg px-2 py-2 text-left transition-colors hover:bg-muted"
                        >
                          <div>
                            <p className="text-xs font-medium text-foreground">{entry.title}</p>
                            <p className="mt-0.5 text-[11px] leading-4 text-muted-foreground">{entry.description}</p>
                          </div>
