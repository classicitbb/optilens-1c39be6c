...
import { AlertTriangle, BookOpenCheck, CircleCheckBig, Compass, Microscope, ShieldCheck } from "lucide-react";
...
const STUDIES = [
  {
    ...
    finding: "MiSight soft contact lenses significantly slowed myopia progression and axial elongation versus single-vision controls over 3 years.",
  },
  {
    citation:
    ...
    finding: "High-add multifocal soft lenses slowed myopia progression compared with single-vision contact lenses.",
  },
  {
    citation:
  ...
  },
  {
    ...
    finding: "Atropine showed a concentration-dependent effect, with stronger control at higher low-dose concentrations.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pb-20 pt-24">
        <section className="container mx-auto max-w-6xl px-4 lg:px-8">
          ...
          <h1 className="mt-3 text-4xl font-bold text-foreground sm:text-5xl">Myopia Control: Honest Guide for Parents and Patients</h1>
        ...
        <section className="mt-20 bg-muted/40 py-16">
          <div className="container mx-auto max-w-6xl px-4 lg:px-8">
            <h2 className="text-2xl font-bold text-foreground">All validated options (including ortho-k and contacts)</h2>
            ...
            <CardContent className="p-6">
              ...
              <ul className="mt-4 space-y-4 text-sm text-muted-foreground">
                <li>
                  ...
                  <a href="https://iotlenses.com/Discover-our-lenses/Myopia-Management-Lenses.html" target="_blank" rel="noreferrer" className="text-primary underline-offset-4 hover:underline">
                ...
                {STUDIES.map((study) => (
                  <li key={study.citation}>
                    ...
                    <a href={study.link} target="_blank" rel="noreferrer" className="text-primary underline-offset-4 hover:underline">
                      {study.link}
                    </a>
                  </li>
                ))}
