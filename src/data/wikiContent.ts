...
- Open the App Launcher from the top bar to switch between business applications such as Pricing, Sales, CRM, Leads, Helpdesk, Website, Knowledge, Settings, and Moonshot
...
- **Monday** — Review Moonshot scorecards, update rocks, and prepare for the weekly team meeting
    ...
    articles: [
      {
        ...
        title: "Moonshot Operating System",
        content: `## What is Moonshot

Moonshot is a strategic execution framework built into the platform. It provides the structure and tools for leadership teams to move from reactive management to disciplined, accountable weekly execution.

The system is designed around a weekly meeting cadence supported by scorecards for measurement, rocks for quarterly priorities, todos for tactical execution, and issues for blocker resolution.

## Core components

- **Dashboard** — An executive pulse view showing the health of strategic metrics and team execution
- **Workspace** — A central operating board that brings together all active scorecards, rocks, todos, and issues in a single view
- **Meetings** — Structured meeting management with agenda preparation, real-time note capture, and action item tracking
- **Scorecards** — Weekly KPI tracking with target versus actual comparisons for each team member
- **Rocks** — Quarterly strategic priorities with clear ownership, milestones, and progress indicators
- **Todos** — Short-term action items with due dates and completion tracking
- **Issues** — An issues list for logging and resolving execution blockers
- **Business Plan** — Long-horizon strategic documentation including vision, mission, and annual goals
- **Tools** — Organisational utilities including org charts, one-on-one meeting frameworks, and right-person-right-seat assessments

## Weekly execution rhythm

1. Before the weekly meeting, each team member updates their scorecard numbers, rock progress, and todo status
2. The meeting leader creates the meeting agenda pulling from scorecards, rocks, todos, and issues
3. During the meeting, the team reviews metrics, identifies off-track items, and surfaces new issues
4. Issues are discussed, prioritised, and assigned with dispositions: solve, delegate, or defer
5. New todos are created for action items arising from the meeting
6. The meeting concludes with accountability checks — every action has one owner and one due date`,
      },
      {
        id: "moonshot-dashboard-guide",
        title: "Moonshot Dashboard",
        content: `## Overview

The Moonshot Dashboard provides an executive summary of strategic health across all team metrics and priorities.

## Dashboard elements

- **Scorecard summary** — Shows how many KPIs are on track versus off track for the current week
- **Rock progress** — Displays quarterly rock completion percentages with status indicators
- **Todo completion** — Tracks the ratio of completed versus outstanding action items
- **Issues count** — Shows the number of open issues awaiting resolution
- **Team health** — Aggregates individual performance across all Moonshot components

## How to use the dashboard

Review the dashboard at the start of each week to identify areas needing attention before the team meeting. Drill into specific sections by clicking on any summary card to navigate to the detailed page.`,
      },
      {
        id: "moonshot-workspace-guide",
        title: "Moonshot Workspace",
        content: `## Overview

The Workspace is the central operating board for Moonshot execution. It provides a unified view of all active work items across scorecards, rocks, todos, and issues.

## Workspace layout

The workspace uses a grid layout that displays:

- Active scorecard metrics with current week values and trend indicators
- In-progress rocks with ownership and completion percentages
- Outstanding todos sorted by due date with owner assignments
- Open issues prioritised by severity and age

## Using the workspace

The workspace is designed for quick daily check-ins. Scan the board to identify items that need attention, update statuses directly from the workspace cards, and use the workspace as your primary operating view between weekly meetings.`,
      },
      {
        id: "moonshot-meeting-runbook",
        title: "Moonshot Meetings",
        content: `## Overview

Meetings provides structured meeting management for the Moonshot operating cadence. It supports scheduling, agenda preparation, real-time facilitation, and post-meeting action tracking.

## Creating a meeting

1. Navigate to Meetings and click New Meeting
2. Set the meeting date, time, and attendee list
3. The system automatically prepares the agenda by pulling from current scorecards, rocks, todos, and issues

## Running a meeting

1. Open the meeting agenda at the scheduled time
2. Review scorecard numbers — identify any off-track metrics and discuss root causes
3. Walk through rock updates — confirm progress and remove blockers
4. Review todo completion — close completed items and address overdue tasks
5. Process the issues list — discuss each open issue and assign a disposition
6. Capture new todos and action items with owners and due dates
7. Close the meeting with a summary of commitments

## Meeting quality checklist

- Every action item has exactly one owner
- Every owner has a specific due date
- Every issue has a clear disposition: solve now, delegate to someone, or defer to a future meeting
- Meeting notes are saved and accessible for review before the next session`,
      },
      {
        id: "moonshot-scorecards-guide",
        title: "Moonshot Scorecards",
        content: `## Overview

Scorecards track weekly key performance indicators for each team member. They provide objective measurement of whether the business is executing against its targets.

## How scorecards work

- Each team member has a set of measurable KPIs assigned to their scorecard
- Targets are set for each KPI representing the weekly goal
- Actuals are entered each week by the responsible team member
- The system compares targets to actuals and flags items that are off track

## Setting up scorecards

1. Define the KPIs that matter for each team member or role
2. Set numeric targets that represent on-track performance
3. Configure the display format including number formatting and trend direction
4. Assign ownership to the team member responsible for reporting

## Weekly scorecard review

During the weekly meeting, review each scorecard number:

- Green indicates the KPI met or exceeded its target
- Red indicates the KPI fell below its target
- For any red items, discuss the root cause and determine whether corrective action is needed
- Track trends over multiple weeks to identify patterns rather than reacting to single-week variations`,
      },
      {
        id: "moonshot-rocks-guide",
        title: "Moonshot Rocks",
        content: `## Overview

Rocks represent the quarterly strategic priorities that the team commits to completing within a 90-day cycle. They are the bridge between long-term vision and weekly execution.

## What makes a good rock

- It is specific and measurable with a clear definition of done
- It can be completed within the current quarter
- It has a single owner who is accountable for delivery
- It represents a meaningful strategic initiative, not routine operational work

## Managing rocks

1. At the start of each quarter, define three to seven rocks for the team
2. Assign each rock to a single owner
3. Break larger rocks into milestones if needed for progress tracking
4. Update rock status weekly as part of the meeting preparation
5. At quarter end, evaluate each rock as complete or incomplete

## Rock statuses

- **On Track** — Progress is proceeding as planned toward the quarterly deadline
- **Off Track** — Progress has fallen behind and corrective action is needed
- **Complete** — The rock has been fully delivered
- **Incomplete** — The quarter has ended and the rock was not finished`,
      },
      {
        id: "moonshot-todos-guide",
        title: "Moonshot Todos",
        content: `## Overview

Todos capture short-term action items that arise from meetings, rock execution, and day-to-day operations. Every todo has an owner and a due date to ensure accountability.

## Creating todos

- Todos are typically created during weekly meetings when action items are identified
- Each todo requires a clear description of what needs to be done
- Assign exactly one owner who is responsible for completion
- Set a due date that is realistic and within the current meeting cycle

## Managing todos

- Mark todos as complete when the action has been fully executed
- Overdue todos are highlighted automatically and reviewed during the next meeting
- If a todo cannot be completed, discuss it in the meeting and either reassign, reschedule, or convert it to an issue

## Best practices

- Keep todo descriptions specific and actionable — avoid vague items like "follow up on project"
- Set due dates within the current one or two week cycle rather than far into the future
- If a todo keeps rolling over from meeting to meeting, convert it to a rock or an issue for deeper analysis`,
      },
      {
        id: "moonshot-issues-guide",
        title: "Moonshot Issues",
        content: `## Overview

Issues captures execution blockers, strategic concerns, and unresolved problems that require team discussion and resolution. The issues list is reviewed during every weekly meeting.

## Creating issues

- Log an issue whenever you encounter a blocker, concern, or unresolved problem
- Provide a clear description of the issue and its impact on operations or strategy
- Issues do not require a due date — they remain open until resolved through the meeting process

## Issue resolution process

During each weekly meeting, the team processes the issues list:

1. Review each open issue briefly to confirm it is still relevant
2. Prioritise issues by impact and urgency
3. For each prioritised issue, discuss and assign a disposition:
   - **Solve** — Resolve the issue during the meeting and create any resulting todos
   - **Delegate** — Assign the issue to a specific person for offline resolution with a due date
   - **Defer** — Move the issue to a future meeting if it is not yet ready for resolution

## Issue versus todo

If something can be resolved with a simple action, it is a todo. If something requires discussion, multiple stakeholders, or investigation before a solution is clear, it is an issue.`,
      },
      {
        id: "moonshot-business-plan-guide",
        title: "Moonshot Business Plan",
        content: `## Overview

The Business Plan documents the long-horizon strategic direction of the organisation. It captures vision, mission, core values, long-term targets, and annual goals that inform quarterly rock-setting and daily execution.

## Business plan components

- **Vision** — The aspirational long-term outcome the organisation is working toward
- **Mission** — The purpose and value proposition that guides daily decisions
- **Core Values** — The behavioural principles that define the organisation's culture
- **Long-term Targets** — Three to ten year goals with measurable milestones
- **Annual Goals** — Specific objectives for the current year that connect to long-term targets
- **Quarterly Rocks** — The near-term priorities that execute against annual goals

## Maintaining the business plan

- Review and update the business plan annually during strategic planning sessions
- Align quarterly rock-setting with the annual goals documented in the plan
- Reference the plan during weekly meetings when prioritising issues and setting new todos
- Ensure all team members have read access to the plan for strategic context`,
      },
      {
        id: "moonshot-tools-guide",
        title: "Moonshot Tools",
        content: `## Overview

Tools provides organisational assessment and management utilities that support the Moonshot operating system.

## Org Chart

The Org Chart visualises the organisational structure with reporting relationships, seat assignments, and role definitions. It provides a clear view of who is accountable for each function.

## One-on-Ones

The One-on-One framework structures regular individual meetings between managers and their direct reports. These meetings focus on personal development, role satisfaction, and performance alignment.

## Right Person, Right Seat

The Right Person, Right Seat assessment evaluates whether each team member is aligned with both the organisation's core values (right person) and the specific requirements of their role (right seat). This tool helps identify misalignment early and guides development or transition conversations.`,
      },
      {
        id: "moonshot-users-guide",
        title: "Moonshot Users",
        content: `## Overview

Moonshot Users manages the team membership and seat assignments for the Moonshot operating system. This is separate from the platform-wide user management in Settings and focuses specifically on who participates in the Moonshot cadence.

## Managing users

- Add team members to the Moonshot system to include them in scorecards, rocks, todos, and meetings
- Assign roles within the Moonshot context such as leader, member, or observer
- Remove users who are no longer part of the strategic execution team
- User changes in Moonshot do not affect their platform-wide access or role`,
      },
      {
        id: "moonshot-settings-guide",
        title: "Moonshot Settings",
        content: `## Overview

Moonshot Settings configures the preferences and defaults for the Moonshot operating system.

## Configurable options

- Meeting cadence and default scheduling preferences
- Scorecard display formatting and period definitions
- Rock quarter start and end dates
- Todo default due date offsets
- Issue prioritisation categories
- Notification preferences for Moonshot-specific alerts`,
      },
    ],
  },
  {
