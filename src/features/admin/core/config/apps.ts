...
export const ADMIN_APPS = {
  ...
  moonshot: {
    ...
    icon: Rocket,
    baseRoute: '/moonshot',
    defaultRoute: '/moonshot/dashboard',
    featurePrefix: 'moonshot',
    sidebarItems: [
      { label: 'Dashboard', route: '/moonshot/dashboard', icon: MsBoard },
      { label: 'Workspace', route: '/moonshot/workspace', icon: ListChecks },
      { label: 'Meetings', route: '/moonshot/meetings', icon: MessageSquare },
      { label: 'Scorecards', route: '/moonshot/scorecards', icon: TrendingUp },
      { label: 'Rocks', route: '/moonshot/rocks', icon: Mountain },
      { label: 'Todos', route: '/moonshot/todos', icon: CheckSquare },
      { label: 'Issues', route: '/moonshot/issues', icon: AlertCircle },
      { label: 'Business Plan', route: '/moonshot/business-plan', icon: MsPlan },
      { label: 'Tools', route: '/moonshot/tools', icon: MsTools },
      { label: 'Users', route: '/moonshot/users', icon: MsUsers },
      { label: 'Resources', route: '/moonshot/resources', icon: BookOpen },
