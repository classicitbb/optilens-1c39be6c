...
export const NAVIGATION_REGISTRY: NavigationDefinition[] = [
  ...
  { id: "admin.helpdesk", routeId: "admin.helpdesk", label: "Helpdesk", context: "admin-console", group: "launcher", appKey: "helpdesk", order: 5, status: "active" },
  { id: "admin.website", routeId: "admin.website", label: "Website", context: "admin-console", group: "launcher", appKey: "website", order: 6, status: "active" },
  { id: "admin.docstudio", routeId: "admin.docstudio", label: "Doc Studio", context: "admin-console", group: "launcher", appKey: "docstudio", order: 7, status: "active" },
