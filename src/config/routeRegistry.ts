...
export const APP_ROUTE_REGISTRY: RouteDefinition[] = [
  ...
  { id: "public.lens-assistant", path: "/lens-assistant", domain: "public-site", audience: "public", authMode: "public", layout: "customer-shell", navGroup: "public-main", status: "active" },
