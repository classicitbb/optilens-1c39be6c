...
export const APP_ROUTE_REGISTRY: RouteDefinition[] = [
  ...
  { id: "admin.orders.quotations", path: "/admin/orders/quotations", domain: "admin-console", audience: "staff", authMode: "admin", layout: "admin-shell", navGroup: "admin", status: "active" },
  { id: "admin.orders.quotations.new-rx", path: "/admin/orders/quotations/new-rx", domain: "admin-console", audience: "staff", authMode: "admin", layout: "admin-shell", navGroup: "admin", status: "active" },
  { id: "admin.orders.quotations.rx", path: "/admin/orders/quotations/rx/:id", domain: "admin-console", audience: "staff", authMode: "admin", layout: "admin-shell", navGroup: "admin", status: "active" },
