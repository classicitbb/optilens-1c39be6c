                      ...
                      <>
                        <td key={`${name}-${mat}-full`} className="border-r border-border p-0" style={{ background: "hsl(215 60% 97%)" }}>
                          <input
                            ...
                            className="w-full px-2 py-1.5 text-left bg-transparent outline-none focus:bg-primary/5 focus:ring-1 focus:ring-inset focus:ring-primary/30 rounded-sm [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                          />
                        </td>
                        <td key={`${name}-${mat}-delta`} className="border-r border-border last:border-r-0 p-0">
                          <input
                            ...
                            className="w-full px-2 py-1.5 text-left bg-transparent outline-none focus:bg-primary/5 focus:ring-1 focus:ring-inset focus:ring-primary/30 rounded-sm [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none text-emerald-700"
                          />
                        </td>
                      </>
                    );
