...
const BREADCRUMB_ROUTE_ALIASES: Record<string, string> = {
  "/professionals": "/for-professionals",
};

const VALID_BREADCRUMB_PATHS = new Set<string>([
  "/",
  "/auth",
  "/reset-password",
  "/store",
...
const resolveBreadcrumbTarget = (path: string) => {
  const normalizedPath = BREADCRUMB_ROUTE_ALIASES[path] ?? path;
  if (VALID_BREADCRUMB_PATHS.has(normalizedPath)) {
