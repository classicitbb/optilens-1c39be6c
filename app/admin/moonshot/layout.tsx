...
export default function MoonshotLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-[280px] bg-[#0f766e] text-white flex flex-col transition-transform ${open ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}
      >
