...
export const PLATFORM_RESOURCE_DETAIL: Record<string, PlatformResourceDetail> = {
  ...
  "shipment_documents": {
    ...
    "columns": "id,shipment_id,source_kind,original_file_name,mime_type,byte_size,created_at",
    "searchColumns": [
      "original_file_name"
    ],
    "writable": [],
  ...
  "shipment_document_extractions": {
    ...
    "columns": "id,shipment_id,document_id,document_kind,status,extracted_text,extracted_fields,created_at,approved_at",
    "searchColumns": [
      "extracted_text"
    ],
    "writable": [],
  ...
  "shipment_document_templates": {
    ...
    "columns": "id,supplier_id,document_kind,fingerprint,approved_field_mapping,usage_count,last_used_at,created_at",
    "searchColumns": [],
    "writable": [],
    "writeClass": "read-only"
  },
