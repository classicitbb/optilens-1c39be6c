...
REVOKE ALL ON FUNCTION public.log_security_event(text, text, text, integer, uuid, text, text, text, text, text, text, jsonb, timestamptz) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.log_security_event(text, text, text, integer, uuid, text, text, text, text, text, text, jsonb, timestamptz) TO service_role;
