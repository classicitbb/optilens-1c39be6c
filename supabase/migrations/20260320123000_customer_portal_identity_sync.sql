ALTER TABLE public.profiles
  ...
  ADD COLUMN IF NOT EXISTS crm_customer_id integer REFERENCES public.customers(id) ON DELETE SET NULL,
  ADD COLUMN IF NOT EXISTS email_verified_at timestamptz,
  ADD COLUMN IF NOT EXISTS profile_completed_at timestamptz,
  ADD COLUMN IF NOT EXISTS portal_access_status text NOT NULL DEFAULT 'pending_profile',
  ADD COLUMN IF NOT EXISTS portal_access_note text;

CREATE INDEX IF NOT EXISTS profiles_crm_contact_id_idx ON public.profiles(crm_contact_id);
CREATE INDEX IF NOT EXISTS profiles_crm_customer_id_idx ON public.profiles(crm_customer_id);
CREATE INDEX IF NOT EXISTS profiles_portal_access_status_idx ON public.profiles(portal_access_status);
