-- Iris financial-data capability: only existing application admins may receive
-- internal finance context. Customer access continues through the separately
-- scoped portal-account feature functions; this does not grant raw data access.
