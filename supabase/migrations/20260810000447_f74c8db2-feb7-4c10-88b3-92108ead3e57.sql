...
REVOKE ALL ON FUNCTION public.protect_profile_privileged_fields() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.protect_profile_privileged_fields() TO authenticated, service_role;
