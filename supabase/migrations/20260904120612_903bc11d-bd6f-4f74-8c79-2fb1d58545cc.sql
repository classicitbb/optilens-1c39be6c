CREATE OR REPLACE FUNCTION public.get_customer_payment_profile(p_customer_id integer DEFAULT NULL::integer)
 RETURNS TABLE(customer_id integer, account_number text, name text, pay_by_card boolean, pay_by_eft boolean, eft_institution_name text, default_payment_type text)
 LANGUAGE plpgsql
